...
- [Backup & Cloud Storage](#backup--cloud-storage)
- [Books & Documentaries](#books--documentaries)
- [Browser Extensions](#browser-extensions)
- [Desktop Settings & Apps](#desktop-settings--apps)
- [Email Aliasing](#email-aliasing)
- [Encrypted Messaging](#encrypted-messaging)
- [Links & Resources](#links--resources)
- [Mobile Settings & Apps](#mobile-settings--apps)
- [Multifactor Authentication](#multifactor-authentication)
- [Password Managers](#password-managers)
- [Payment Masking](#payment-masking)
...
- Services should be accessible to individual end-users. Services like realtime messaging, password managers, or email often have a B2B component. This is fine, but they must also have a consumer-facing arm for individual end users to easily join and use the service.
...
- Email aliasing is not the same as temporary or burner emails. Email aliases must offer persistent email addresses that forward to an existing inbox for long-term use and easy management
- Must allow users to initiate a new email conversation from an alias
- Must allow users to create a realistically large number of aliases (at least hundreds)
- Must at least offer a web portal to manage the account and aliases
- Must support PGP encryption
...
- Must support creating, storing, importing, and exporting passkeys
- Must offer tools to help identify potential password vulnerabilities such as weak, reused, or breached passwords
- Must be [recently audited](/criteria/#definitions)
...
- Must not keep logs
- Must have source-available clients
- Must offer ad/tracker/malware blocking in some reasonable capacity
- Must offer at least one form of anonymous payment (cash, Monero, or ZCash)
- Apps must be available on all operating systems
