...
Please note that note every tool on this website is 100% private or secure against all adversaries. For example, [VoIP numbers](/guides/less-important/voip/) will not provide end-to-end [encryption](/guides/prologue/encryption/) and should not be used for sensitive communications. The [threat model](/guides/prologue/threat-model/) of this website is to help people of "typical" threat models evade mass surveillance capitalism. The alternatives offered on this site offer more privacy than their Big Tech counterparts, but nothing is 100% secure, and not all tools are equally secure. If you have an elevated threat model, please do additional research to determine what tools are right for you and know their limiations.
