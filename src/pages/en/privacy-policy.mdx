...
2. Umami Analytics are shared in realtime for the main website (thenewoil.org) at https://stats.thenewoil.org/thenewoil.org
...
For any legal request(s), question(s), or concern(s) in regards to this policy or your data, please email us at [legal@thenewoil.org](mailto:legal@thenewoil.org) for assistance in regards to said request(s) or concern(s) about this policy or your data.