...
<img src="/images/logos/spn.png" alt="spn logo" class="float-right mx-6 w-24" />
VPNs were never designed for privacy. They were designed to allow employees to securely
...
Network](https://safing.io/spn/) - from Safing, the company behind [Portmaster](https://safing.io/)
- aims to solve these problems. SPN takes a hybrid approach between a VPN and Tor
