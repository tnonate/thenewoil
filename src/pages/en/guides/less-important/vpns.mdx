...
**[Click here to see my criteria for selecting these services](https://gitlab.com/thenewoil/website/-/wikis/VPN-Criteria)**

*[For more information on providers not listed here, see Techlore's VPN Toolkit.](https://techlore.tech/vpn)*

## Honorable Mention: Safing Private Network

<img src="/images/logos/spn.png" alt="spn logo" class="w-24 float-right mx-6" />VPNs were never designed for privacy. They were designed to allow employees to securely connect to the company network to access company resources and intellectual property while offsite. It's only in the last few decades that commercial VPNs became widely available to private citizens and were co-opted for privacy uses. However, this has left a significant number of inadequacies in their current protections (see [Tips & Tricks](/guides/less-important/vpns/#tips--tricks) below). The [Safing Private Network](https://safing.io/spn/) - from Safing, the company behind [Portmaster](https://safing.io/) - attempts to solve these problems. SPN attempts to take a hybrid approach between a VPN and Tor to achieve to maximum user privacy while also retaining user-friendliness, speed, and stability. Some features include giving each app a unique IP address, a multi-hop node architecture, and the ability to easily split-tunnel apps with the click of a toggle. SPN is still very early in beta testing and is currently considered unstable, however early adopters who desire a stronger solution than traditional VPNs have to offer may wish to look into this option.
