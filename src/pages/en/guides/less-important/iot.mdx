...
I strongly recommend using Mozilla's "[*Privacy Not Included](https://foundation.mozilla.org/en/privacynotincluded/)" as a starting point to research various popular IoT devices and offerings. I personally disagree with some of their conclusions (like failing to tag iRobot products as "privacy not included" despite being [acquired by Amazon](https://www.techtarget.com/searchcio/news/252524792/Amazons-iRobot-acquisition-raises-concerns)) but it will at least provide a starting point for some products to outright ignore and offer alternatives to research.
