...
**VoIP is not meant to replace [secure messaging](/guides/moderately-important/messaging).** Just as with a regular SMS/MMS/RCS, you should assume that anything you submit - be it text, voice, or video - is recorded and plainly visible to any companies and or governments. VoIP solutions are recommended purely as a way to keep your data out of the hands of people search websites and protect you against relatively unsophisticated threats like stalkers and doxxers.
