...
Generally speaking, **I advise against using Google Drive, Dropbox, iCloud, or similar services**, primarly because they are not [zero-knowledge](/guides/prologue/encryption). For those wondering about iCloud's Advanced Data Protection setting, see [here](/guides/less-important/backups#iclouds-advanced-data-protection-program). If you must use one of the other mainstream providers, [see below](/guides/less-important/backups#mainstream-cloud-providers).
