...
This website addresses a "typical" threat model of mass surveillance capitalism for the average person. We assume that you are not being specifically singled out by an advanced attacker such as a nation state, intelligence agency, or abusive partner. We assume that you are not a millionaire, politician, or public figure who is likely to attract special attention. The threat model we cater to is that you simply want more privacy and security to protect yourself against common scams, excessive data collection, unsophisticated hacking attempts, and unlawful collection of your data by law enforcement without a warrant.
