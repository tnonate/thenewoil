...
There are two problems with relying strictly on the current TLS model of the internet, however.

First is that it only protects "**data in transit**." When you connect to Amazon, your ISP can only see that you visited Amazon, but Amazon themselves can still see every page, click, and purchase without restriction. This opens up the risk of data breaches, malicious insider threats, and more.
