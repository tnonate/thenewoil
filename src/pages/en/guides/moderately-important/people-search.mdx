...
Unlike most other pages on this website, I actually do list these services in order of recommendation. Based on the previously-mentioned research, EasyOptOuts is the best "bang for your buck" with a 65% success rate and only $20/year. Optery is slightly more effective (68%), but significantly more expensive.

For the sake of offering more options, I also suggest DuckDuckGo Privacy Pro. Please note that they were not included in Consumer Reports' research and at this time, I am manually investigating their efficacy. I will be updating this site once I have more solid results to compare with.
...
As of 2026, California residents also have access to the [Delete Request and Opt-out Platform (DROP)](https://privacy.ca.gov/drop/). It doesn't legally take effect until August 1, however residents can start submitting requests now.
