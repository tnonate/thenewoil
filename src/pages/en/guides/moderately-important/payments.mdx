...
Aside from being highly invasive, this kind of information also poses a risk. **Credit card information is highly vulnerable to being stolen** in a data breach, and the economic information gathered about you (like income and net worth) frequently makes its way onto [people search websites](/guides/moderately-important/people-search). Furthermore, many insurance companies are pushing for a world where big data - including your purchases - can determine things like your health insurance rates and coverage, employability, and rental eligibility ([Source, paywalled](https://www.wsj.com/articles/SB10001424127887323384604578326151014237898); [source](https://www.hlhunt.org/uncategorized/the-other-file-the-shadow-bureaus-that-gate-housing-banking-and-work/); [source](https://www.thesisdriven.com/letters/the-state-of-modern-tenant-screening/)).

Protecting your financial information is a critical part of protecting both your privacy and security.

## Cash

The easiest way to protect your financial privacy is to **use cash whenever possible.** The advantages go beyond privacy. For one, cash has been proven to help people [spend less](https://money.com/pay-with-cash-value-of-money-study/), so it'll save you money. Another is that it keeps you from overspending by removing the possibility.

A common concern is that by carrying cash you make yourself a target for mugging, but remember that criminals don't have x-ray vision or psychic powers. They don't know if you're carrying cash instead of cards or how much.

## Digital Wallets

Digital wallets - like Apple Pay and Google Pay - offer more privacy and security benefits than a traditional debit or credit card. If you're unable to pay with cash, a digital wallet can be a better option in some cases. Note that not all digital wallets are equal - some offer more privacy or security than others. This video from Jonah Aragon is a good introduction to some of the pros and cons that go into Apple and Google Pay.

<div style="position: relative; padding-top: 56.25%;"><iframe title="Digital wallet privacy &amp; security in under 3 and a half minutes" width="100%" height="100%" src="https://neat.tube/videos/embed/qVzaCWej1ooyDVdChnABcX" allow="fullscreen" sandbox="allow-same-origin allow-scripts allow-popups allow-forms" style="border: 0px; position: absolute; inset: 0px;"></iframe></div>

## Online Payments

While digital wallets can be used online, there are some services that focus on providing virtual cards and offer additional privacy and security benefits over digital wallets. Note that **none of these are anonymous**; all of them are required to abide by various anti-fraud "Know Your Customer" laws which will require them to verify your identity to deter fraud, laundering, and tax evasion. Remember that these strategies are to protect against general data breaches, online theft of card numbers, and less sophistocated stalkers or attackers, not tools for total anonymity against governments.
...
Second, the sudden growth combined with the general ignorance of how cryptocurrencies work has made the cryptocurrency space rife with fraud and "get rich quick" scams. Coinbase alone [lists](https://www.coinbase.com/price) over 19,000 cryptocurrencies available for purchase and trade on their site. I find it hard to believe that each one is designed to solve an actual problem or serve a specific purpose other than making someone money. Only a small few cryptocurrencies are genuine attempts to improve the space: faster transactions, cheaper transactions, privacy, anonymity, etc.

Finally, the volatility of cryptocurrency makes it dangerous and unfeasible to rely on heavily in spaces where a stable currency and easy access to banking exist. If you live in such a place, I only recommend small monetary investments in cryptocurrency as a hobby and just a little time spent keeping up-to-date on emerging trends. If you live in a part of the world where your currency is highly unstable and/or your banking system is not easily accessible, this advice may be different but I'm not qualified to speak on that.
