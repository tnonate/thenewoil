...
The second method is called a "**brute force attack.**" This is where the hacker specifies parameters (such as "upper and lower case letters" and length) and the software guesses every possibility, starting with "aaaaaa,"then moving on to "aaaaab," and so on. Passwords less than six characters, regardless of complexity, can be [brute forced](https://protonmail.com/blog/how-long-should-my-password-be/") in less than a second.
