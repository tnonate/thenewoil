...
I encourage you to remove any unused or infrequenly-used apps from your phone. Mobile apps are both invasive for privacy and a potential entry point for <dfn title="malicious software, commonly (but not always accurately) known as a virus">malware</dfn> and attackers so the fewer you have, the better. Additionally, **if your phone is lost or stolen, having sensitive apps like work email and banking can allow further abuse.**

I also encourage you to try to trade using apps for using the website, even on mobile. Many apps you rely on can function just fine in the website, or as a Progressive Web App (PWA). You can learn more about those [here](https://apertatube.net/w/9n5G9HZyxEhbuvAc48Rwdt).
