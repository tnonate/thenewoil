...
import data from "@assets/data/pages/en/guides/most-important/Payments.json";
...
**[Click here to see my criteria for selecting these services](https://gitlab.com/thenewoil/website/-/wikis/Payment-Masking-Criteria)**
...
To fully dive into the complexities of cryptocurrency falls far outside the scope of this website. It would take an entire other website to explain how they work, how to use them correclty, which ones are worth your time, and more. If you would like to learn more about cryptocurrencies, I recommend [Bitcoiner.guide](https://bitcoiner.guide/), [Coinbureau's Resource Hub](https://www.coinbureau.com/resource-hub/), [Decentralize.Today](https://dt.gl/), and [Opt Out Podcast](https://optoutpod.com/). I trust these resources to be rational and truthful to the best of their ability in a space flooded with sensationalism and exaggeration.
