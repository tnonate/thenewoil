...
/>
**If you decide to go with Brave, you don't need to add any additional
extensions** (except, optionally, Snowflake. See the next paragraph for more
information). **If you decide to go with Firefox, you should install [uBlock
Origin](https://ublockorigin.com/)**, a powerful, lightweight ad- and
tracker-blocker. Malicious, fake ads designed to scam you or trick you into
downloading malware (called "malvertising") have become such a serious problem
that even the FBI
[recommends](https://techcrunch.com/2022/12/22/fbi-ad-blocker/) that you use an
ad-blocker. Additionally, the online advertising model has become one of the
most
[prolific](https://www.eff.org/deeplinks/2025/01/online-behavioral-ads-fuel-surveillance-industry-heres-how)
and invisible privacy threats out there. Officially, uBlock Origin is ready for
use "out of the box." You can choose to enable more filters if you'd like, but
be aware that some suggest this could make you stand out to trackers online.
...
inclined. The first is your [password
manager's](/guides/most-important/passwords) official extension. Many password
managers offer browser extensions to help make logging in easy and safe. There
are numerous advantages to these, like protection against phishing and
keyloggers, and as such I consider these okay to install if you want to. The
other is [Snowflake](https://snowflake.torproject.org/) (this is optionally
included in Brave, see the recommended settings below). This is a project to
help certain internet users in foreign, repressive countries bypass censorship.
This should not cause any kind of legal risk to you. Both of these extensions
are optional, but I believe they are safe to use.
...
Mullvad Browser with a [VPN](/guides/less-important/vpns/)). Furthermore, the
Mullvad Browser offers a number of "hardening"
[features](https://mullvad.net/en/browser/hard-facts) that make it more private
and secure than regular Firefox. However, these changes may come at the cost of
some possible site breakage from time to time, including breaking certain
security features that I encourage (like the use of [hardware security
...
issues - however my advice to keep a backup browser (at the bottom of this page)
is particularly salient if you choose to do so.
