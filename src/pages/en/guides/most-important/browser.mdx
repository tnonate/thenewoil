...
<img src="/images/logos/ublock.png" alt="ublock logo alt" class="w-24 float-left mx-6"/>**If you decide to go with Brave, you don't need to add any additional extensions** (except for the ones in the next paragraph if you decide). **If you decide to go with Firefox, you should install [uBlock Origin](https://ublockorigin.com/)**,
a powerful, lightweight ad- and tracker-blocker. Officially, uBlock Origin is ready
for use "out of the box." However, there's a few things I prefer to modify to
improve the protections and convenience it has to offer. First, I enable every option under the "[Privacy](*PUBLIC*/images/steps/ublock-setup/step1.jpg)"
section. Next, click on the tab “[Filter lists](*PUBLIC*/images/steps/ublock-setup/step2.jpg)” and start by clicking on the toggle that says "Suspend network activity until all filter lists are loaded." This may require you to wait a few seconds before you can start browsing every time you open the browser, but it will ensure you are as protected as possible the entire time. Finally,
enable "AdGuard URL Tracking Protection" and "EasyList Cookie" under "Privacy" and “Annoyances" respectively. These will disable tracking links - a major threat to privacy - and those annoying cookie banners (respectively).

<img src="/images/logos/snowflake.png" alt="snowflake logo" class="w-24 float-left mx-6" />There are two additional extensions that I think are worth adding if you feel so
inclined. The first is your [password manager's](/guides/most-important/passwords) official
extension. Many password managers offer browser extensions to help make logging in
easy and safe. There are numerous advantages to these, like protection against phishing
and keyloggers, and as such I consider these okay to install if you want to. The
other is [Snowflake](https://snowflake.torproject.org/) (this is optionally included in Brave, see the recommended settings below). This is a project to help
certain internet users in foreign, repressive countries bypass censorship. This should
not cause any kind of legal risk to you. Both of these extensions are optional, but
I believe they are safe to use. I strongly advise against installing any other extensions
unless absolutely necessary. The more extensions you install, the more easily your
browser can be fingerprinted, making it easier to track you across the web despite
any other privacy-enhancing changes you make to your browser or browsing habits.
