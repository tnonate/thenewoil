...
export const languages = config.languages.sort((a: Language, b: Language) => (a.weight - b.weight));
export const defaultLanguage = config.languages.find((lang) => lang.isDefault === true);

if (!defaultLanguage) throw Error("A default language needs to be set in the config.json. Add 'isDefault: true' to any language");
...
export const getUrlInLanguage = async (url: URL, targetLanguage: LanguagesCodes) => {
